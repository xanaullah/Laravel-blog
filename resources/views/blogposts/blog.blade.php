...
<main class="container">
      ...
      <section class="cards-blog latest-blog">
        ...
        <div class="card-blog-content">
          <img src="{{asset('mages/pic2.jpg')}}" alt="" />
          <p>
            2 days ago
            <span>Written By Alphayo Wakarindi</span>
          </p>
          <h4 style="font-weight: bolder">
            <a href="{{route('single-blog.show')}}">WRC Safari Rally Back To Kenya After 19 Years</a>
          </h4>
        </div>

        <div class="card-blog-content">
          <img src="{{asset('mages/pic1.jpg')}}" alt="" />
          <p>
            3 days ago
            <span>Written By Alphayo Wakarindi</span>
          </p>
        ...
        <div class="card-blog-content">
          ...
          <h4 style="font-weight: bolder">
            <a href="{{route('single-blog.show')}}">12 Health Benefits Of Pomegranate Fruit</a>
          </h4>
        </div>
        ...
        <div class="card-blog-content">
          ...
          <h4 style="font-weight: bolder">
            <a href="{{route('single-blog.show')}}">Nairobi, The Only City In The World With A National Park</a>
          </h4>
        </div>
